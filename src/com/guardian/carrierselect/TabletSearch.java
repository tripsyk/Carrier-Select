...
public class TabletSearch extends Fragment {
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		rootView = inflater.inflate(R.layout.tabletsearch1, container, false);
...
/*
				...
				editor.putString("ts1", searchTerm.getText().toString());
				editor.commit();
