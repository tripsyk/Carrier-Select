...
public class WearableSearch extends Fragment {
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		rootView = inflater.inflate(R.layout.wearsearch1, container, false);
...
/*
				...
				editor.putString("ws1", searchTerm.getText().toString());
				editor.commit();
